...
.. image:: https://github.com/jadsonbr/python-vimrc/wiki/img/screenshot.png
...
.. code-block:: bash
  ...
  sh -c "$(curl -fsSL https://raw.githubusercontent.com/jadsonbr/python-vimrc/master/setup.sh)"
